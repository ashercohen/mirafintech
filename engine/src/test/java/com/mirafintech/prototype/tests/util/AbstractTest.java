...
import com.mirafintech.prototype.tests.util.exception.DataAccessException;
import com.mirafintech.prototype.tests.util.providers.DataSourceProvider;
import com.mirafintech.prototype.tests.util.providers.Database;
import com.mirafintech.prototype.tests.util.providers.LockType;
import com.mirafintech.prototype.tests.util.transaction.*;
...
public abstract class AbstractTest {
    ...
    protected com.mirafintech.prototype.tests.util.PersistenceUnitInfoImpl persistenceUnitInfo(String name) {
        com.mirafintech.prototype.tests.util.PersistenceUnitInfoImpl persistenceUnitInfo = new com.mirafintech.prototype.tests.util.PersistenceUnitInfoImpl(
    ...
    protected com.mirafintech.prototype.tests.util.DataSourceProxyType dataSourceProxyType() {
        return com.mirafintech.prototype.tests.util.DataSourceProxyType.DATA_SOURCE_PROXY;
    }
    ...
    protected Database database() {
        return Database.POSTGRESQL;//.HSQLDB;
    }
    ...
    private void printCacheRegionStatisticsEntries(String regionName) {
        ...
        if (cacheRegionStatistics != null) {
            AbstractRegion region = com.mirafintech.prototype.tests.util.ReflectionUtils.getFieldValue(cacheRegionStatistics, "region");
    ...
    private net.sf.ehcache.Cache getEhcache(StorageAccess storageAccess) {
        ...
        return com.mirafintech.prototype.tests.util.ReflectionUtils.getFieldValue(storageAccess, "cache");
    }
